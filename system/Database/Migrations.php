...
require_once ("system/Database/Model.php");
...
class Migration extends Model
{
    private $createTableQueries = array(
        ...
        "CREATE TABLE `users` (
          ...
          `password` varchar(191) COLLATE utf8_persian_ci NOT NULL,
          `permission` enum('user','admin') COLLATE utf8_persian_ci NOT NULL DEFAULT 'user',
          `status` tinyint(5) COLLATE utf8_persian_ci NOT NULL DEFAULT '0',
          `is_active` tinyint(5) COLLATE utf8_persian_ci NOT NULL DEFAULT '0',
          `verify_token` varchar(191) COLLATE utf8_persian_ci DEFAULT NULL,
          `remember_token` varchar(191) COLLATE utf8_persian_ci DEFAULT NULL,
